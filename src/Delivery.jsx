    ...
    >
      ...
      >
        ...
        >
          ...
          >
            После отправки заказа клиент получит
            номер для отслеживания поссылки
            по SMS-сообщению.
            ...
            Если возникли вопросы по заказу, вы можете связаться со службой поддержки через раздел «Поддержка» и уточнить все интересующие Вас вопросы, касающийся товара, доставки, оплаты и возврата.
          </div>
        </div>
      </div>
    </div>
